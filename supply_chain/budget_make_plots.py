...
maxs = np.array([2.01,4.01,9.51,4.01, 2.6, 3.2])
...
cost=np.zeros(shape=(4,1,6,20)) 
costOneAll=np.zeros(shape=(4,1)) 
Mask=np.ones(shape=(4,1,6,20),dtype=bool) 
factoryNum=np.zeros(shape=(4,1,6,20))
factoryNumOneAll=np.zeros(shape=(4,1))
portNumOneAll=np.zeros(shape=(4,1))
pctLocal=np.zeros(shape=(4,1,6,20,2))
